        ...
        <div>
            ...
            <form action="edit_ministry_model.php" method="POST" enctype="multipart/form-data" class="p-3">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="name" placeholder="Name..." autocomplete="off" value="<?= $ministry['ministryName'] ?>">
                </div>
                <div class="form-group">
                ...
                <div class="text-right">
                    <a href="http://localhost/php_project/?page=1&s=1#ministry" type="reset" class="btn btn-warning">Cancel</a>
